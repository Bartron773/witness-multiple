...
- HTML5
- Include all CSS inside the HTML document.
- Include JavaScript only if genuinely useful to the artifact.
- Do not require React, npm, a build process, or external application frameworks.
- The file should open directly in a modern browser.
...
- If external fonts are unavailable, provide sensible fallback fonts.
...
Return ONLY the final HTML artifact when possible.
